  ...
  return (
    <BaseScreen header={<Header showBackButton />}>
      <View style={{ marginTop: 12, marginBottom: 16, gap: 8 }}>
        <Typography style={{ fontWeight: '700', fontSize: fontSizeSchemas["3xl"] }} text="Editar Perfil" />
      </View>
      <View>
        ...
        <Button onPress={handleProfileDelete} style={{ marginTop: 32 }} variants="error" >
          <Typography text={"Apagar conta"} />
        </Button>
      </View>
    </BaseScreen>
  )
